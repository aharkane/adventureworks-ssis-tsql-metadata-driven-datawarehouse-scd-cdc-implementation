...
| DWH_Table | Source_OLTP_Tables | Row_Count | SCD_Type | Natural_Key_From_OLTP | Surrogate_Key_DWH | Key_Attributes |
|-----------|-------------------|-----------|----------|----------------------|-------------------|-----------------|
| **DimAddress** | Person.Address<br>Person.StateProvince<br>Sales.SalesTerritory<br>Person.CountryRegion | 450 | Type 0 | AddressID | AddressDWKey | City, PostalCode, StateProvinceName, TerritoryName, CountryRegionName |
| **DimCustomer** | Sales.Customer<br>Sales.Store<br>Person.Person<br>Sales.SalesTerritory<br>Person.CountryRegion | 30,119 | Type 1 & 2 | CustomerID | CustomerDWKey | FirstName (Type 2), LastName (Type 2), StoreName (Type 1), JobTitle (Type 1), TerritoryName (Type 1), IsCurrent, ValidityDate_Start, ValidityDate_End |
| **DimProduct** | Production.Product<br>Production.ProductCategory<br>Production.ProductSubcategory<br>Production.UnitMeasure | 504 | Type 1 & 2 | ProductID | ProductDWKey | ProductName, ProductColor, ListPrice (Type 2), StandardCost (Type 1), ProductSize, IsCurrent, ValidityDate_Start, ValidityDate_End |
| **DimSalesPerson** | Sales.SalesPerson<br>HumanResources.Employee<br>Person.Person<br>Sales.SalesTerritory | 17 | Type 1 & 2 | SalesPersonID | SalesPersonDWKey | FirstName (Type 2), LastName (Type 2), JobTitle (Type 1), SalesQuota (Type 1), Commission (Type 1), IsCurrent, ValidityDate_Start, ValidityDate_End |
| **FactSales** | Sales.SalesOrderHeader<br>Sales.SalesOrderDetail | 121,317 | Transactional | SalesOrderID, SalesOrderDetailID | Pass-through from OLTP | OrderDate, OrderQty, UnitPrice, LineTotal, OrderSubTotal, OrderFreight, OrderTotalDue |
...
| Document | Purpose |
|----------|---------|
| **[Data-Dictionnary.xlsx](Documentation/Data-Dictionnary.xlsx)** | Complete OLTP → DWH table mappings, column transformations, SCD types |
| **[OLTP-Tables-Diagram-and-listing.md](Documentation/OLTP-Tables-Diagram-and-listing.md)** | Visual table relationships and ER diagrams |
| **[OLT-Tables-List.md](Documentation/OLT-Tables-List.md)** | Source system table listing |
| **[PROJECT-STRUCTURE.md](PROJECT-STRUCTURE.md)** | Detailed file organization and execution sequence |
| **[INSTALLATION-GUIDE.md](INSTALLATION-GUIDE.md)** | Step-by-step deployment instructions |
| **[ARCHITECTURE.md](ARCHITECTURE.md)** | Design decisions and architectural patterns |
| **[QUICK-START.md](QUICK-START.md)** | 10-minute setup guide |
| **[DATA-LINEAGE.md](DATA-LINEAGE.md)** | OLTP source to DWH transformation mapping |
| **[DATA-LINEAGE-DIAGRAMS.md](DATA-LINEAGE-DIAGRAMS.md)** | Visual data flow diagrams |
| **[NATURAL-vs-SURROGATE-KEYS.md](NATURAL-vs-SURROGATE-KEYS.md)** | Key design patterns and implementation |
| **[DWH-MAPPING-TABLE.md](DWH-MAPPING-TABLE.md)** | Complete data dictionary in markdown |
...
From data dictionary to installation guide - demonstrates professional communication skills.
